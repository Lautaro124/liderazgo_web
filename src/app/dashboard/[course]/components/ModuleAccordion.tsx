  ...
  return (
    <div className="flex flex-col gap-4">
      {modules.map((module) => (
        <div
          key={module.id}
          className="border-b border-gray-200 bg-white rounded-lg shadow-lg"
        >
          <button
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between w-full gap-3 items-center">
                ...
                <span className="ml-2 text-sm text-gray-500">
                  ...
                  {module.classes.length > 1 ? "clases" : "clase"})
                </span>
              </div>
            ...
            <div className="px-6 pb-4">
              <div className="space-y-3">
                {module.classes.map((classItem) => (
                  <Link key={classItem.id} href={`/dashboard/${module.id}/${classItem.id}`}>
                    <div
